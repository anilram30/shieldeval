...
[private vulnerability reporting](https://github.com/anilram30/shieldeval/security/advisories/new), or email sreeramanil30@gmail.com.

Expect an acknowledgement within a week.

## Scope and threat model

`shieldeval` reads measurement data files, configuration files and, in some packages, instrument
